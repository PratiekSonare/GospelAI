...
export default function Modes({ onModeSelect, currentMode }) {
    const [active, setActive] = useState(Array(11).fill(false));
    const [activeTwo, setActiveTwo] = useState(Array(11).fill(false));
    const [activeThree, setActiveThree] = useState(Array(11).fill(false));
